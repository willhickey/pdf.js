        ...
        if (textLayer) {
          self.getTextContent().then(
            function textContentResolved(textContent) {
			  ...
			  //whickey add highlighting here
			  console.log("Search should be available now: " + self.id);
			  //window.alert("text layer resolved");
			  
			  //PDFView.termHighlightController
			  PDFView.termHighlightController.calcFindSearchTerm(self.id, 'then');
