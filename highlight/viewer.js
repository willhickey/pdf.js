...
//#include pdf_term_highlight_controller.js
...
var PDFView = {
  ...
  initialize: function pdfViewInitialize() {
	...
	this.termHighlightController = new PDFTermHighlightController({
		pdfPageSource: this,
      integratedFind: this.supportsIntegratedFind
	});
/*	PDFTermHighlightController.initialize({
		pdfPageSource: this,
      integratedFind: this.supportsIntegratedFind
    });*/
	/*this.termHighlightController = new PDFTermHighlightController({
...
//console.log("updateviewarea.  First Page: " + firstPage.id);
